(function () {
  ...
  // Displays the next question and updates the progress bar
  function displayNext() {
    quiz.fadeOut(function () {
      ...
      if (questionCounter < questions.length) {
        ...
        // Show 'audio' defined in question object
        ...
        // Show 'content' and 'qType' defined in question object
        ...
        // Set the radio button based on the saved selection
        if (!isNaN(selections[questionCounter])) {
        ...
        // After the last question, ensure progress bar shows 100%
